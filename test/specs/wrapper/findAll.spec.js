...
describeWithShallowAndMount('findAll', mountingMethod => {
  ...
  it('throws an error when passed an invalid DOM selector', () => {
    ...
    const wrapper = mountingMethod(compiled)
    const message =
      '[kdu-test-utils]: wrapper.findAll() must be passed a valid CSS selector, Kdu constructor, or valid find option object'
  ...
  it('returns an array of KduWrappers of Kdu Components matching component', () => {
    const wrapper = mountingMethod(ComponentWithChild)
    const componentArr = wrapper.findAll(Component)
    expect(componentArr.length).to.equal(1)
  })

  it('returns an array of KduWrappers of Kdu Components matching components using findAllComponents', () => {
    const wrapper = mountingMethod(ComponentWithChild)
  ...
  it('throws an error if findAllComponents selector is a CSS selector', () => {
    ...
    const message =
      '[kdu-test-utils]: findAllComponents requires a Kdu constructor or valid find object. If you are searching for DOM nodes, use `find` instead'
  ...
  it('throws an error if chaining findAllComponents off a DOM element', () => {
    const wrapper = mountingMethod(ComponentWithChild)
    const message =
      '[kdu-test-utils]: You cannot chain findAllComponents off a DOM element. It can only be used on Kdu Components.'
  ...
  it('returns correct number of Kdu Wrapper when component has a k-for', () => {
  ...
  it('returns array of KduWrappers of Kdu Components matching component if component name in parent is different to filename', () => {
    const wrapper = mountingMethod(ComponentWithChild)
  ...
  it('returns an array of KduWrappers of Kdu Components matching component using Wrapper as reference', () => {
  ...
  it('only returns Kdu components that exists as children of Wrapper', () => {
    const AComponent = {
      render: () => {},
      name: 'a-component'
    }
  ...
  it('returns matching Kdu components that have no name property', () => {
    const TestComponent = {
      template: `
        <div>
  ...
  it('returns Wrapper of Kdu Component matching functional component', () => {
  ...
  it('returns KduWrapper with length 0 if no nodes matching selector are found', () => {
    const wrapper = mountingMethod(Component)
  ...
  it('returns correct number of Kdu Wrapper when component has a k-for and matches the ref in options object', () => {
    const items = [{ id: 1 }, { id: 2 }, { id: 3 }]
    const wrapper = mountingMethod(ComponentWithKFor, { propsData: { items } })
  ...
  it('returns KduWrapper with length 0 if no nodes matching the ref in options object are found', () => {
    const wrapper = mountingMethod(Component)
  ...
  itDoNotRunIf(
    ...
    'returns a WrapperArray which includes KduWrapper if the elements binds a Kdu instance',
    () => {
