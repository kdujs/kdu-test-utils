...
import ComponentWithKShow from '~resources/components/component-with-k-show.kdu'
...
describeWithShallowAndMount('isVisible', mountingMethod => {
  ...
  it('returns true if element has k-show true', async () => {
    const wrapper = mountingMethod(ComponentWithKShow)
  ...
  it('returns false if element has k-show true', async () => {
    const wrapper = mountingMethod(ComponentWithKShow)
    wrapper.vm.$set(wrapper.vm, 'ready', true)
    await Kdu.nextTick()
  ...
  it('returns true if parent element has k-show true', async () => {
    const wrapper = mountingMethod(ComponentWithKShow)
    wrapper.vm.$set(wrapper.vm, 'ready', true)
    await Kdu.nextTick()
  ...
  it('returns false if parent element has k-show false', async () => {
    const wrapper = mountingMethod(ComponentWithKShow)
    wrapper.vm.$set(wrapper.vm, 'ready', true)
    await Kdu.nextTick()
  ...
  it('returns false if root element has k-show false and parent has k-show true', async () => {
    const wrapper = mountingMethod(ComponentWithKShow)
    wrapper.vm.$set(wrapper.vm, 'ready', true)
  ...
  it('returns false if root element has k-show true and parent has k-show false', async () => {
    const wrapper = mountingMethod(ComponentWithKShow)
