...
import ComponentWithParentName from '~resources/components/component-with-parent-name.kdu'
...
describeWithShallowAndMount('options.slots', mountingMethod => {
  ...
  itDoNotRunIf(
    ...
    () => {
      ...
      localKdu.component('custom-component', CustomComponent)
      const TestComponent = {
  ...
  itDoNotRunIf(
    process.env.TEST_ENV === 'node' || kduVersion < 2.3,
  ...
  it('throws error if passed string in default slot object and kdu-template-compiler is undefined', () => {
    const compilerSave =
  ...
  it('throws error if passed string in default slot array kdu-template-compiler is undefined', () => {
    const compilerSave =
      require.cache[require.resolve('kdu-template-compiler')].exports
        .compileToFunctions
    require.cache[
  ...
  it('throws error if passed false for named slots', () => {
    ...
    const message =
      '[kdu-test-utils]: slots[key] must be a Component, string or an array of Components'
    expect(fn)
      .to.throw()
      .with.property('message', message)
  })
  ...
  it('throws error if passed string in default slot array when kdu-template-compiler is undefined', () => {
    const compilerSave =
      require.cache[require.resolve('kdu-template-compiler')].exports
        .compileToFunctions
    require.cache[
  ...
  it('sets a component which can access the parent component and the child component', () => {
    ...
    let ParentComponent = mount(
      ...
      },
      {
        ...
        slots: {
          default: [
            '<component-with-parent-name :fromLocalKdu="bar" />',
            '<component-with-parent-name :fromLocalKdu="bar" />'
          ]
        },
        localKdu
