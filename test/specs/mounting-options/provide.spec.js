...
import ComponentWithInject from '~resources/components/component-with-inject.kdu'
import CompositionComponentWithInject from '~resources/components/component-with-inject-composition.kdu'
import { injectSupported } from '~resources/utils'
import { describeWithShallowAndMount } from '~resources/utils'
import { itDoNotRunIf, itSkipIf } from 'conditional-specs'
import KduCompositionApi from '@kdujs/composition-api'
...
describeWithShallowAndMount('options.provide', mountingMethod => {
  ...
  itDoNotRunIf(
    ...
    () => {
      ...
      localKdu.use(KduCompositionApi)
