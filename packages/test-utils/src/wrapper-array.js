...
export default class WrapperArray implements BaseWrapper {
  +wrappers: Array<Wrapper | KduWrapper>
  +length: number
  selector: Selector | void

  constructor(wrappers: Array<Wrapper | KduWrapper>) {
  ...
  at(index: number): Wrapper | KduWrapper {
  ...
  isKduInstance(): boolean {
    ...
    return this.wrappers.every(wrapper => wrapper.isKduInstance())
  }
