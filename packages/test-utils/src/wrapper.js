...
export default class Wrapper implements BaseWrapper {
  ...
  rootNode: KNode | Element
  selector: Selector | void

  constructor(
    node: KNode | Element,
    options: WrapperOptions,
    isKduWrapper?: boolean
  ) {
    const knode = node instanceof Element ? null : node
  ...
  setMethods(methods: Object): void {
    ...
    if (this.knode) {
      const context = this.knode.context
  ...
  setProps(data: Object): Promise<void> {
    ...
    const originalConfig = Kdu.config.silent
